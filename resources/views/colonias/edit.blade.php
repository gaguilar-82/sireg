    ...
    <form action="{{route('colonias.update', $colonia)}}" onSubmit="javascript:procesar();" method="POST">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="NombreColonia" placeholder="Colonia" class="form-control mb-2" value="{{old('NombreColonia', $colonia->NombreColonia)}}">
          </div>
          <div class="form-group col-md-6">
            ...
            <select name="TipoColonia" id="inputTipoColonia" class="form-control">
                ...
                <option value="Parque Nacional El Veladero" @if ($colonia->TipoColonia == 'PNV') selected="selected" @endif>Parque Nacional El Veladero</option>
            </select>
          </div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
          <div class="form-group col-md-9">
              ...
              <textarea name="ObservacionesColonia" placeholder="Observaciones" rows="4" cols="100" maxlength="100" class="form-control" mb-2 >{{ $colonia->ObservacionesColonia}}</textarea>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group col-md-3">
